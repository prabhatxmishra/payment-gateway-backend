package com.prabhatxmishra.razorpay.payment.service.impl;
...
import com.prabhatxmishra.razorpay.payment.repository.OrderRepository;
...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderResponse create(UUID merchantId, CreateOrderRequest request) {
        if(request.receipt()!=null && orderRepository.existsByMerchantIdAndReceipt(merchantId, request.receipt())){
            throw new DuplicateRequestException("Order with receipt already exists"+request.receipt());
        }
